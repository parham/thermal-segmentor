...
RUN pip install pytorch-ignite torchmetrics torchvision pydensecrf comet-ml opencv-python scikit-image scikit-learn dotmap phasepack cython pyyaml matplotlib
